 ...
 *
 * Zarządza operacjami CRUD na artykułach.
 */
class ArticleController extends AbstractController
{
     ...
     * @param SluggerInterface $slugger Slugger for URL generation
     * @param TranslatorInterface $translator Translator for messages
     */
    public function __construct(private readonly EntityManagerInterface $entityManager, private readonly ArticleRepository $articleRepository, private readonly CategoryRepository $categoryRepository, private readonly SluggerInterface $slugger, private readonly TranslatorInterface $translator)
    {
    }
