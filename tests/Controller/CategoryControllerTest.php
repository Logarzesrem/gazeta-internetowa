...
class CategoryControllerTest extends BaseTestCase
{
    ...
    public function testCategoryDeleteWithoutAuth(): void
    {
        ...
        $client->request('POST', '/en/categories/'.$category->getSlug());
        $this->assertResponseRedirects();
    }
    ...
    /**
     * Test category show with invalid slug.
     */
    public function testCategoryShowWithInvalidSlug(): void
    {
        $client = static::createClient();
        $client->request('GET', '/en/categories/invalid-slug');
